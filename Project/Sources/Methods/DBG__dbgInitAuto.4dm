...
If (Count parameters:C259>0)
	...
	If ($vb_logComponentIsInstalled)
		  //If the component is installed, we set the name of the DBG component method to execute into an interprocess variable
	...
	Else 
		  //If the component is not installed, we leave the interprocess variable empty. 
